...
import com.zx.qz.dao.AdsQzDao
import org.apache.spark.sql.expressions.Window
import org.apache.spark.sql.types.DataType
import org.apache.spark.sql.{RelationalGroupedDataset, SaveMode, SparkSession}
...
object AdsQzService {
  def getTargetAPI(sparkSession: SparkSession, dt: String): Unit = {
    ...
    val userQuestionDetail =
      sparkSession.sql("select * from dws.dws_user_paper_detail").cache()
